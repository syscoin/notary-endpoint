...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                diskSpaceRemaining = _a.sent();
                diskSpaceRemaining = Number(((diskSpaceRemaining[0].size - diskSpaceRemaining[0].used) /
                    (1024 * 1024)).toFixed(2));
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
            ...
            case 3:
                res.send({
                    ...
                    diskSpaceRemaining: diskSpaceRemaining
                });
                return [2 /*return*/];
        }
    });
